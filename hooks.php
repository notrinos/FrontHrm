...
class FrontHrm_app extends application {
    ...
    function FrontHrm_app() {
        ...
        $this->add_rapp_function(2, 'Salary Scales', $path_to_root.'/modules/FrontHrm/manage/manage_salaryscale.php', 'SA_HRSETUP', MENU_MAINTENANCE);
		$this->add_rapp_function(2, 'Payroll Accounts', $path_to_root.'/modules/FrontHrm/manage/manage_accounts.php', 'SA_HRSETUP', MENU_MAINTENANCE);
		$this->add_rapp_function(2, 'Payroll Rules', $path_to_root.'/modules/FrontHrm/manage/manage_payroll_rules.php', 'SA_HRSETUP', MENU_MAINTENANCE);
